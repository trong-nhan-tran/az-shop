...
export async function GET(
  ...
  try {
    ...
    return toNextResponse(await flashSaleService.getById(id));
  } catch (error: unknown) {
...
export async function PUT(
  ...
  try {
    ...
    return toNextResponse(await flashSaleService.update(id, body));
  } catch (error: unknown) {
    return toNextResponse(internalServerErrorResponse());
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return toNextResponse(await flashSaleService.delete(id));
  } catch (error: unknown) {
    return toNextResponse(internalServerErrorResponse());
  }
}
